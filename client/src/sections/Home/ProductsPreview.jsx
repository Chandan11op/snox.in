    ...
    <section className="py-24 bg-industrial-chrome relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row justify-between items-end mb-16">
          ...
          <Link 
            to="/products" 
            className="group hidden md:flex items-center text-primary font-semibold hover:text-accent transition-colors mt-6 md:mt-0"
          >
            View All Products
            ...
            >
              ...
              <div className="p-8">
                ...
                <Link 
                  ...
                  className="inline-flex items-center font-semibold text-primary group-hover:text-accent transition-colors"
                >
                  View Details
                  <motion.span
                    className="ml-2"
        ...
        <div className="mt-12 text-center md:hidden">
          <Link 
            to="/products" 
            className="inline-flex items-center justify-center bg-primary text-white px-8 py-3 rounded-full font-semibold w-full hover:bg-primary-light transition-colors"
          >
            View All Products
          </Link>
        </div>
