export const productsData = [
  {
    id: 'sanitary-tc-clamp',
    slug: 'sanitary-tc-clamp',
    ...
    specifications: {
      ...
      'Surface Finish': 'Electro-polished (< 0.8 Ra)',
      'Pressure Rating': 'Up to 10 Bar (150 PSI)'
    },
    applications: ['Breweries', 'Water Treatment', 'Wineries', 'Dairy Industries', 'Pharmaceuticals']
  },
  {
    id: 'sanitary-ferrules',
    slug: 'sanitary-ferrules',
    ...
    specifications: {
      ...
      'End Connection': 'Weld End to Tri-Clamp'
    },
    applications: ['Food Processing', 'Chemical Processing', 'Dairy']
  },
  {
    id: 'pipe-holder-hanger',
    slug: 'pipe-holder-hanger',
    ...
    specifications: {
      ...
      'Insert': 'High-temp Silicone / EPDM (optional)'
    },
    applications: ['Pipeline Infrastructure', 'Vibration Dampening']
  },
  {
    id: 'tc-hose-adaptor',
    slug: 'tc-hose-adaptor',
    ...
    applications: ['Flexible Transfer Lines', 'Brewery Hoses']
  },
  {
    id: 'ss-valves-tri-weld',
    slug: 'ss-valves-tri-weld',
    ...
    applications: ['Flow Control', 'Isolation', 'CIP Systems']
  },
  {
    id: 'ss-spray-ball',
    slug: 'ss-spray-ball',
    ...
    specifications: {
      ...
      'Cleaning Radius': 'Up to 3 meters'
    },
    applications: ['Tank Cleaning (CIP)', 'Vats', 'Silos']
  },
  {
    id: 'ss-y-strainer',
    slug: 'ss-y-strainer',
    ...
    specifications: {
      ...
      'Gasket': 'FDA Approved EPDM'
    },
    applications: ['Particulate Filtration', 'Pump Protection']
  },
  {
    id: 'ss-sight-glass',
    slug: 'ss-sight-glass',
    ...
    specifications: {
      'Sizes': '1" to 6"',
      'Max Temp': '150°C',
      'Max Pressure': '10 Bar (depends on size)'
    },
    applications: ['Visual Flow Inspection', 'Process Monitoring']
  },
  {
    id: 'ss-pneumatic-valves',
    slug: 'ss-pneumatic-valves',
    ...
    specifications: {
      'Sizes': '1" to 4"',
      'Air Supply': '5-7 Bar',
      'Control Head': 'C-Top / Proximity Switches (Optional)'
    },
    applications: ['Automated Processing', 'CIP/SIP Sequencing']
  }
];